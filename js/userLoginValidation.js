// const userAuthorizationForm = document.querySelector('#userAuthorizationForm'),
//       uaFormInputs = document.querySelectorAll('.uaFormEmptyClass')
//
// document.querySelector('#uaFormBtn').addEventListener('click', function() {
//   uaFormInputs.forEach(function(input) {
//     if(input.value === '') {
//       input.classList.add('border-color-warning')
//       console.log('non')
//     } else input.classList.remove('border-color-warning')
//
